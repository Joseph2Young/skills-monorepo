...
1. Read [skill/workflow.md](skill/workflow.md) for the canonical workflow.
...
8. Read only the relevant sections of the linked `core/` and `references/` files described by [skill/workflow.md](skill/workflow.md).
