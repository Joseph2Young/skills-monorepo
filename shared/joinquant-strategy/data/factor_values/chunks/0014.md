...
| inventory\_turnover\_rate | 存货周转率 | 存货周转率=营业成本（TTM）/AvgQ(存货,4,0) |
...
| accounts\_payable\_turnover\_rate | 应付账款周转率 | TTM(营业成本,0)/（AvgQ(应付账款,4,0) + AvgQ(应付票据,4,0) ） |
...
| account\_receivable\_turnover\_rate | 应收账款周转率 | 即，TTM(营业收入,0)/（AvgQ(应收账款,4,0)+ AvgQ(应收票据,4,0)） |
